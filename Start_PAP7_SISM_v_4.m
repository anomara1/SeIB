...
for i = file_index:file_index%322000
    ...
    pre_res  = strcat('PAP7_ALL_VARS_RESULTS/PAP7_OMP_ALL');
    dicType_ = 'SDic';
    ...
    [OMP_RAND_RESULTS_ALL] = PAP7_main_code(fName,ori_bpp,batchSize,sparse,dicType_,JPEG_RES,JPEG2000_RES,'ALL','randomized');
    [OMP_MODO_RESULTS_ALL] = PAP7_main_code(fName,ori_bpp,batchSize,sparse,dicType_,JPEG_RES,JPEG2000_RES,'ALL','modortho');
    %%%%%%%%%%%%%%%%%%%%
