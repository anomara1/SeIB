...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%RES_MiOMP_AAA_DS_256 = load('AAA_MiOMP_48_256_256');
%GI_5 = [14 27 32  41];%[14 16 18 24 27 29 32 35 37 40 41 42 43 44];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%RES_MiOMP_AAA_DS_128 = load('AAA_MiOMP_48_128_128');
%GI_6 = [14 27 32  41];%[14 16 18 24 27 29 32 35 37 40 41 42 43 44];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%RES_MiOMP_AAA_DS_1000_64 = load('AAA_MiOMP_1000_64_64');
GI_7 = [3 27 57 62 93 97 99];%[14 16 18 24 27 29 32 35 37 40 41 42 43 44];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
x = load('BBB_MiOMP_1000_64_64');%RES_MiOMP_AAA_DS_1000_64; %RES_BBB_DS_128;%RES_BBB_DS_256;
res_ = x;%x.x;
...
for i = 1:1:10
    for j =1:1:length(GI_sel)%100
        GI = GI_sel;
       count = 1;
       X = res_.RES(GI(j)).RES;%.res;%res_.RES(GI(j),1);%.RES;%res_.RES(GI(j)).RES;%{GI(j)};%.res;
    ...
    res_ttest(i,:) = [ res_ssim_fixed_temp(i,1) my_ttest(ss(:,2),ss(:,3)) my_ttest(ss(:,2),ss(:,4)) my_ttest(ss(:,2),ss(:,5)) my_ttest(ss(:,2),ss(:,6)) ...
        my_ttest(ss(:,2),ss(:,7)) my_ttest(ss(:,2),ss(:,8)) my_ttest(ss(:,2),ss(:,9)) my_ttest(ss(:,2),ss(:,10)) my_ttest(ss(:,2),ss(:,11)) my_ttest(ss(:,2),ss(:,12))];
