...
function Start_PAP7_SISM_v_4_EXP4_get_Dics_128()
imageSize = 128;
img_double = [];
...
switch alg
        ...
        case 'lkdl'
            for j = 1:1:1
                ...
                params.dictsize = No_ATOMS;%number of atoms
                params.Tdata = 5;%sparsity level;
                params.iternum = 3;%number of iterations
          ...
          save(strcat('EXP4_LKDL_DIC_',int2str(No_ATOMS)),'Dic');            
