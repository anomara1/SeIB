...
function Start_PAP7_SISM_v_2(file_index)
clc;
batchSize = 256;%16,8
sparse = 128;
...
for i = file_index:file_index%322000
    ...
    pre_res  = strcat('PAP7_OMP_EOMP_ALL_VARS_RESULTS/PAP7_OMP_ALL');
    dicType_ = 'SDic';
    [SDIC_RESULTS_ALL] = PAP7_main_code(fName,ori_bpp,batchSize,sparse,dicType_,JPEG_RES,JPEG2000_RES,'ALL');
    ...
    save(strcat(pre_res,'_file_','(',int2str(i),')'),'SDIC_RESULTS_ALL');
    check = 0;
...
function [RESULTS] = PAP7_main_code_(img,ori_bpp,batchSize,sparse_,dicType,JPEG_RES,JPEG2000_RES,IAM_IBM_NOTIFY) %#ok<*INUSD>
%BRE_IMG Summary of this function goes here
%   Detailed explanation goes here
global bits_per_coeff;
global bits_per_index;
