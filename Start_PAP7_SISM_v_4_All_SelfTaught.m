...
function Start_PAP7_SISM_v_4_All_SelfTaught(file_index)
clc;
batchSize = 256;%16,8
sparse = 128;
...
for i = file_index:file_index%322000
    ...
    pre_res  = strcat('PAP7_ALL_VARS_RESULTS/PAP7_OMP_ALL_SELF_TAUGHT_');
    dicType_ = 'SDic';
    [OMP_SDIC_RESULTS_ALL] = PAP7_main_code(fName,ori_bpp,batchSize,sparse,dicType_,JPEG_RES,JPEG2000_RES,'ALL','dct');
    dicType_ = 'LDic';
    [OMP_KSVD_RESULTS_ALL] = PAP7_main_code_LDIC(fName,ori_bpp,batchSize,sparse,dicType_,JPEG_RES,JPEG2000_RES,'ALL',1);
    [OMP_MOD_RESULTS_ALL] = PAP7_main_code_LDIC(fName,ori_bpp,batchSize,sparse,dicType_,JPEG_RES,JPEG2000_RES,'ALL',2);
   % [OMP_RAND_RESULTS_ALL] = PAP7_main_code_LDIC(fName,ori_bpp,batchSize,sparse,dicType_,JPEG_RES,JPEG2000_RES,'ALL','randomized');
    ...
    save(strcat(pre_res,'_file_','(',int2str(i),')'),'OMP_SDIC_RESULTS_ALL','OMP_KSVD_RESULTS_ALL','OMP_MOD_RESULTS_ALL');%,'OMP_RAND_RESULTS_ALL','OMP_MODO_RESULTS_ALL');
    check = 0;
...
err_threshold = 35:-3:5;
mod_threshold = 20:-10:10;
OVERALL_TIME = [];
OVERALL_PARA = [];
OVERALL_SSIM_avg = [];
OVERALL_SSIM_FIN = [];
...
function [RESULTS] = PAP7_main_code_LDIC(img,ori_bpp,batchSize,sparse_,dicType,JPEG_RES,JPEG2000_RES,IAM_IBM_NOTIFY,LDIC_TYPE) %#ok<*INUSD>
%BRE_IMG Summary of this function goes here
%   Detailed explanation goes here
global bits_per_coeff;
global bits_per_index;
